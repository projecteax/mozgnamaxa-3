    ...
    <div className="w-full max-w-4xl">
      ...
      <div className="flex justify-center gap-4 mt-1 w-full">
        ...
        <div className="flex gap-4 items-end">
          ...
          <div 
            className={`relative w-36 h-14 transition-all ${(userLoggedIn && !isCompleted && !isHistoricallyCompleted) || isCompleted ? 'cursor-not-allowed opacity-50' : 'cursor-pointer hover:scale-105'}`}
            onClick={(userLoggedIn && !isCompleted && !isHistoricallyCompleted) || isCompleted ? undefined : onNext}
          >
            <Image 
              src={theme.wrocDalejButton || "/images/wroc_dalej_wiosna.svg"} 
              alt="Dalej button" 
