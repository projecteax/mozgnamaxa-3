...
export default function MemoryMatchGame2x4({ onMenuClick, onBack, onNext, onRetry, userLoggedIn = false, currentSeason = "wiosna", isGameCompleted = false }: MemoryMatchGame2x4Props) {
  // Use the game completion hook
  const { recordCompletion, isLoggedIn, isHistoricallyCompleted } = useGameCompletionWithHistory("memory-match-game-2x4")
    ...
    <div className="w-full max-w-4xl">
      ...
      <div className="flex justify-center gap-4 mt-8 w-full">
        ...
        <div className="flex gap-4 items-end">
          {/* WRÓĆ Button - always available in memory-match-game-2x4 */}
          <div 
